...
export default function ChatWindow() {
  ...
  const { activeConversation, setActiveConversation, fetchMessages, sendMessage, messages, setMessages, fetchConversations, joinGroup, leaveGroup, conversations, setShowGroupInfo } = useContext(ChatContext);
